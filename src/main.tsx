...
/**
 * The fail-LOUD surface for a broken boot. Restored after commit 34588bc
 * removed it and swapped in a silent fallback to open mode — the exact
 * behaviour the header comment above forbids (see issue #5).
 *
 * This is also the correct signal for a static host with no /api proxy or a
 * backend without CORS for this origin: the shape guard in fetchRuntimeConfig
 * turns "index.html with a 200" into this screen, instead of into an ungated
 * app whose every data pane is broken.
 */
