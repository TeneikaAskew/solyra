...
| Playwright: `http://localhost:5199 is already used` | Leaked Vite from an interrupted run. Kill it. `reuseExistingServer: false` is deliberate — do not "fix" it by enabling reuse. |
