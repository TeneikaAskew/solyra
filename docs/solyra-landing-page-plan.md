...
**Files:**
- Create: `src/routes/LandingPage.tsx` (skeleton — full content in Tasks 3–7)
- Modify: `src/App.tsx`
- Modify: `src/components/layout/navConfig.ts:40`
- Modify: `src/components/shared/RouteErrorBoundary.tsx:51`
- Modify: e2e specs that visit the dashboard at `/` (exact list in Step 5)
- NOT modified: `src/components/auth/AuthGate.tsx` — it keeps its current behavior (signed-out firebase → `SignInScreen`), it just moves inside the router around the app group.
...
`src/components/layout/navConfig.ts` line 40:

```ts
      { path: '/dashboard', label: 'Dashboard', icon: LayoutDashboard },
```

`src/components/shared/RouteErrorBoundary.tsx` line 51:
...
- `tests/auth.setup.ts:21`
- `tests/phase1-charts.spec.ts:9`
- `tests/gamma-levels.spec.ts:109`
- `tests/navigation.spec.ts:67`
- `tests/dashboard.spec.ts:140,150,156,166,183`

Then sweep for stragglers (URL assertions, other `'/'` literals) and fix any that refer to the dashboard:

```bash
grep -n "goto('/')\|toHaveURL('/')\|toHaveURL(/\\\\/$/)" tests/*.ts
```
...
```bash
git add src/routes/LandingPage.tsx src/App.tsx src/components/layout/navConfig.ts src/components/shared/RouteErrorBoundary.tsx tests
...
- Create: `src/components/landing/fixtures.ts`
- Create: `src/components/landing/useTypingLines.ts`
- Create: `src/components/landing/LandingNav.tsx`
- Create: `src/components/landing/Hero.tsx`
- Modify: `src/routes/LandingPage.tsx`
...
Replace `src/routes/LandingPage.tsx` with:
...
```bash
git add src/components/landing src/routes/LandingPage.tsx
...
**Files:**
- Create: `src/components/landing/BentoGrid.tsx`
- Modify: `src/routes/LandingPage.tsx`
...
```bash
git add src/components/landing/BentoGrid.tsx src/routes/LandingPage.tsx
...
**Files:**
- Create: `src/components/landing/ChartShowcase.tsx`
- Modify: `src/routes/LandingPage.tsx`
...
```bash
git add src/components/landing/ChartShowcase.tsx src/routes/LandingPage.tsx
...
**Files:**
- Create: `src/components/landing/ModuleDives.tsx`
- Create: `src/components/landing/DailyRhythm.tsx`
- Modify: `src/routes/LandingPage.tsx`
...
```bash
git add src/components/landing/ModuleDives.tsx src/components/landing/DailyRhythm.tsx src/routes/LandingPage.tsx
...
**Files:**
- Create: `src/components/landing/waitlist.ts`
- Test: `src/components/landing/waitlist.test.ts`
- Create: `src/components/landing/WaitlistSection.tsx`
- Create: `src/components/landing/LandingFAQ.tsx`
- Modify: `src/routes/LandingPage.tsx` (final composition)
...
Create `src/components/landing/waitlist.test.ts`:
...
- Possibly modify: `src/components/landing/fixtures.ts` (proof number)
