...
| D | README.md | package.json, vite.config.ts | |
...
| D | docs/UI-SCREENS.md | src/routes, src/components | |
| D | docs/DESIGN_SYSTEM.md | src/index.css, tailwind.config.ts, src/components/primitives | |
