...
|---|---|---|---|
| Landing | `/` | `https://solyra-api-prod-5sjtb3yl7a-ue.a.run.app/` | `http://localhost:5173/` |
| Welcome redirect | `/welcome` | `https://solyra-api-prod-5sjtb3yl7a-ue.a.run.app/welcome` | `http://localhost:5173/welcome` |
| Dashboard | `/dashboard` | `https://solyra-api-prod-5sjtb3yl7a-ue.a.run.app/dashboard` | `http://localhost:5173/dashboard` |
| Live Market | `/live` | `https://solyra-api-prod-5sjtb3yl7a-ue.a.run.app/live` | `http://localhost:5173/live` |
| Charts | `/charts` | `https://solyra-api-prod-5sjtb3yl7a-ue.a.run.app/charts` | `http://localhost:5173/charts` |
| Options Flow | `/options` | `https://solyra-api-prod-5sjtb3yl7a-ue.a.run.app/options` | `http://localhost:5173/options` |
| Playbook | `/playbook` | `https://solyra-api-prod-5sjtb3yl7a-ue.a.run.app/playbook` | `http://localhost:5173/playbook` |
| Reports | `/reports` | `https://solyra-api-prod-5sjtb3yl7a-ue.a.run.app/reports` | `http://localhost:5173/reports` |
| Signals | `/signals` | `https://solyra-api-prod-5sjtb3yl7a-ue.a.run.app/signals` | `http://localhost:5173/signals` |
| Journal | `/journal` | `https://solyra-api-prod-5sjtb3yl7a-ue.a.run.app/journal` | `http://localhost:5173/journal` |
| AI Insights | `/insights` | `https://solyra-api-prod-5sjtb3yl7a-ue.a.run.app/insights` | `http://localhost:5173/insights` |
| Catalysts | `/catalysts` | `https://solyra-api-prod-5sjtb3yl7a-ue.a.run.app/catalysts` | `http://localhost:5173/catalysts` |
| Admin | `/admin` | `https://solyra-api-prod-5sjtb3yl7a-ue.a.run.app/admin` | `http://localhost:5173/admin` |
| Help & Glossary | `/help` | `https://solyra-api-prod-5sjtb3yl7a-ue.a.run.app/help` | `http://localhost:5173/help` |
| Settings | `/settings` | `https://solyra-api-prod-5sjtb3yl7a-ue.a.run.app/settings` | `http://localhost:5173/settings` |

Operational endpoints outside the SPA router: `https://solyra-api-prod-5sjtb3yl7a-ue.a.run.app/dev` (the unauthenticated-on-staging
page — see [09](https://github.com/TeneikaAskew/stocks/blob/main/docs/product/09-SECURITY-AUTH.md)), `https://solyra-api-prod-5sjtb3yl7a-ue.a.run.app/api/health`, `https://solyra-api-prod-5sjtb3yl7a-ue.a.run.app/api/health/freshness`.
